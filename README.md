...
[![x-cmd/install — macvision Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/macvision.svg)](https://x-cmd.com/install/macvision)
...
Total: **3,449** lines of code across **30** files in the top 5 languages.
...
- **Upstream**: <https://github.com/ljh-sh/macvision>
- **Homepage**: <https://macvision.ljh.sh>
- **License**: Apache-2.0
...
- **Stars**: 10 · **Forks**: 0 · **Open issues**: 0 · **Contributors**: 5

## Totals (cumulative)

- **Releases**: 5 · **Merged PRs**: 17 · **Open PRs**: 5 · **Closed issues**: 0 · **Open issues**: 0 · **Commits**: 22
...
_Snapshot: `data/card/260924.yml` · 2026-09-24T05:04:26Z._
