...
[![x-cmd/install — macvision Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/macvision.svg?lang=zh)](https://x-cmd.com/install/macvision)
...
合计: **3,449** 行代码（覆盖前 5 种语言、共 **30** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Swift | 3,089 | 337 | 336 | 26 |
| Sass | 186 | 0 | 39 | 1 |
| JavaScript | 76 | 0 | 14 | 1 |
| Html | 37 | 0 | 2 | 1 |
| Json | 37 | 0 | 0 | 1 |
...
- **上游仓库**: <https://github.com/ljh-sh/macvision>
- **官网**: <https://macvision.ljh.sh>
- **许可证**: Apache-2.0
...
- **Star**: 10 · **Fork**: 0 · **开放 issue**: 0 · **贡献者**: 5

## 累计统计

- **发布数**: 5 · **已合并 PR**: 17 · **开放 PR**: 5 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 22
...
| 90d | 2026-06-26 | 1 | 6 | 5 | 0 | 0 | 6 |
| last180d | 2026-03-28 | 5 | 17 | 5 | 0 | 0 | 21 |
| 360d | 2025-09-29 | 5 | 17 | 5 | 0 | 0 | 21 |
| last720d | 2024-10-04 | 5 | 17 | 5 | 0 | 0 | 22 |
...
macvision 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `macvision` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/macvision.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T05:04:27Z._
